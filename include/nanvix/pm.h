...
#define NANVIX_PM_H_
	 ...
	 */
	/**@{*/
	#define PRIO_IO          180 /**< Waiting for block operation. */
	#define PRIO_BUFFER      160 /**< Waiting for buffer.          */
	#define PRIO_INODE       140 /**< Waiting for inode.           */
	#define PRIO_SUPERBLOCK  120 /**< Waiting for super block.     */
	#define PRIO_REGION      100 /**< Waiting for memory region.   */
	#define PRIO_TTY          80 /**< Waiting for terminal I/O.    */
	#define PRIO_SIG          60 /**< Waiting for signal.          */
